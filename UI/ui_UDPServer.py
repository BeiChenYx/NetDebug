...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.textEdit_send_server = QtWidgets.QTextEdit(self.tab_2)
        self.textEdit_send_server.setObjectName("textEdit_send_server")
        self.gridLayout_3.addWidget(self.textEdit_send_server, 0, 0, 1, 1)
        ...
        self.horizontalLayout_6.addWidget(self.checkBox_times)
        ...
        self.horizontalLayout_6.addWidget(self.lineEdit_times)
        ...
        self.gridLayout_4.addWidget(self.textEdit_send_client, 1, 0, 1, 1)
        ...
        self.lineEdit_clinet_counts.setMaximumSize(QtCore.QSize(100, 16777215))
    ...
    def retranslateUi(self, Form):
        ...
        self.textEdit_send_server.setPlaceholderText(_translate("Form", "数据发送输入"))
